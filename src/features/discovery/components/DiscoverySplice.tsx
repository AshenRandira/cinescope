    ...
    sceneContent = (
      <>
          ...
          {cuts.map((cut, index) => {
            ...
            return (
              <button
                ...
                className={`group min-h-28 border-[var(--color-line-soft)] px-5 py-5 text-left transition-colors md:border-r md:last:border-r-0 ${
                  isActive
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,7,6,0.98)_0%,rgba(5,7,6,0.86)_42%,rgba(5,7,6,0.48)_72%,rgba(5,7,6,0.82)_100%)]"
          />

          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,7,6,0.22)_0%,rgba(5,7,6,0.22)_55%,rgba(5,7,6,0.96)_100%)]"
          />
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`group grid min-h-24 w-full grid-cols-[2.25rem_1fr_auto] items-center gap-3 py-4 text-left transition-colors ${
                          isActive
