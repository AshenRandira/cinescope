    ...
    sceneContent = (
      <>
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,7,6,0.98)_0%,rgba(5,7,6,0.89)_31%,rgba(5,7,6,0.52)_68%,rgba(5,7,6,0.78)_100%)]"
          />

          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,7,6,0.16)_0%,rgba(5,7,6,0.22)_58%,rgba(5,7,6,0.96)_100%)]"
          />
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            className={`mt-4 block text-sm font-semibold leading-5 ${
                              isActive
